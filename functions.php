<?php
/**
 * wpms functions and definitions
 *
...
if ( ! function_exists( 'wpms_setup' ) ) :
	...
	function wpms_setup() {
		 ...
		 * If you're building a theme based on wpms, use a find and replace
		 * to change 'wpms' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'wpms', get_template_directory() . '/languages' );
		...
		add_theme_support( 'custom-background', apply_filters( 'wpms_custom_background_args', array(
...
add_action( 'after_setup_theme', 'wpms_setup' );
 ...
 */
function wpms_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'wpms_content_width', 640 );
}
add_action( 'after_setup_theme', 'wpms_content_width', 0 );
 ...
 */
function wpms_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'wpms' ),
		'id'            => 'sidebar-1',
...
function wpms_scripts() {
	wp_enqueue_style( 'wpms-style', get_stylesheet_uri() );

	wp_enqueue_script( 'wpms-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'wpms-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
